...
function createFallbackCountryProfile(name) {
  ...
  return {
    ...
    why: `${name} can be reviewed as part of a tailored BROVI destination plan based on the applicant’s profile, timeline, and travel purpose.`,
...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="800" viewBox="0 0 1200 800">
  ...
  <text x="600" y="390" text-anchor="middle" font-family="Arial, sans-serif" font-size="44" fill="#001f3f">BROVI</text>
  ...
  moreCountriesList.innerHTML = extraCountries.map((country) => `
    <button class="country-list-btn additional-country-card motion-card" type="button" data-country="${country.key}">
      ...
      <span class="additional-country-card-body">
        ...
        <span class="additional-country-learn-more">Learn More</span>
      </span>
    </button>`).join("");
...
function renderAdditionalCountryDetail(country) {
  ...
  moreCountriesTitle.textContent = "Destination details";
...
function bindEvents() {
  ...
  const openTermsContent = () => openLegal("Terms of Service", `<section><h3>Terms of Service</h3><p>These Terms explain how BROVI delivers visa, education, and travel support services. By using this website or booking support, you agree to these terms.</p></section><section><h4>1) Scope of Services</h4><p>BROVI provides advisory support including consultations, document preparation guidance, interview coaching, travel planning assistance, and general destination information.</p></section><section><h4>2) Eligibility</h4><p>Clients must be legally permitted to apply for their selected program, visa, or travel category and must provide truthful personal and supporting information.</p></section><section><h4>3) Client Responsibilities</h4><p>Clients are responsible for attending meetings, submitting requested records on time, and reviewing all documents before submission to any embassy, school, or third party.</p></section><section><h4>4) Accuracy of Information</h4><p>All outcomes depend on accurate information. Inconsistent, altered, or incomplete records can delay processing or lead to refusal by authorities.</p></section><section><h4>5) Consultation and Advisory Nature</h4><p>BROVI is an advisory consultancy. We prepare and guide, but we do not guarantee approvals because final decisions are made by independent institutions.</p></section><section><h4>6) Fees and Payments</h4><p>Published service plans describe support level and scope. Where fees apply, clients are informed before onboarding. Government or embassy fees are separate unless clearly stated.</p></section><section><h4>7) Third-Party Decisions</h4><p>Embassies, universities, scholarship boards, and border authorities make independent decisions. BROVI cannot override, influence, or reverse those decisions.</p></section><section><h4>8) Timelines and Expectations</h4><p>Processing timelines vary by country, intake, season, and document readiness. Shared timelines are planning estimates, not guaranteed processing dates.</p></section><section><h4>9) Refund, Cancellation, and Rescheduling</h4><p>Consultation slots may be rescheduled with notice. Service fees already used for delivered work or reviews may be non-refundable based on completed scope.</p></section><section><h4>10) Intellectual Property</h4><p>All website content, guidance templates, and branded materials remain the property of BROVI unless otherwise stated.</p></section><section><h4>11) Acceptable Use</h4><p>You agree not to misuse forms, upload harmful files, impersonate others, or use our materials for unlawful activities.</p></section><section><h4>12) Limitation of Liability</h4><p>BROVI is not liable for indirect losses caused by third-party decisions, policy changes, client delays, or inaccurate client-provided information.</p></section><section><h4>13) Indemnification</h4><p>Clients agree to indemnify BROVI against claims arising from falsified records, unauthorized use, or misuse of advisory materials.</p></section><section><h4>14) Privacy Reference</h4><p>Personal information is handled under our Privacy Policy. Please review it for details on data collection, processing, and retention.</p></section><section><h4>15) Service and Term Updates</h4><p>BROVI may update services, terms, and published offers to reflect operational or legal changes. Updated terms apply once posted.</p></section><section><h4>16) Support and Customer Contact</h4><p>For service clarifications, plan scope, or complaint resolution, contact our support team and include your full name and service reference.</p></section><section><h4>17) Contact Information</h4><p>Legal and support inquiries: scelta.infinity@gmail.com.</p></section>`);
  document.getElementById("termsOpen").addEventListener("click", openTermsContent);
